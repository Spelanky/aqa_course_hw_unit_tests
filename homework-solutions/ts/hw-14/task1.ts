...
let keysQA: Record<string, keyof typeof QA>;

// 10. Создайте дженерик функцию wrapInArray, которая принимает значение любого типа и
// возвращает его в виде массива этого типа.
